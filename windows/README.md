...
- 承接原版 v0.1.10 的三段式：那一个 JSON 对象里 `judgment` 排在 `replies` 前面（候选顺着刚写下的
  ...
  `questions.guidance_text()` / `CHOICE_LABELS` 没有消费者，删掉
